                ...
                <div class="card-body">
                    ...
                    @endisset
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                            <input type="text" name="nama" value="{{ isset($item) ? $item->name : old('nama')}}"  class="form-control">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control select-field" name="title">                                    
                                    @foreach ($title as $row)
                                    <option value="{{$row->id}}" {{ isset($item) && $item->titles_id == $row->id ? 'selected' : null }}>{{$row->name}}</option>    
                                    @endforeach                                
                                </select>                                                  
