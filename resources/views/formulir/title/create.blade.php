                ...
                <div class="card-body">
                    ...
                    @endisset
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                            <input type="text" name="nama" value="{{ isset($title) ? $title->name : null}}"  class="form-control">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control select-field" name="con">                                    
                                    @foreach ($da as $row)
                                    <option value="{{$row->id}}" {{ isset($item) && $item->contents_id == $row->id ? 'selected' : null }}>{{$row->name}}</option>    
                                    @endforeach                                
                                </select>                                                  
                        ...
                        <div class="card-footer text-right">
                            ...
                            <a class="btn btn-danger" href="{{route('title.index')}}">Back</a>                        
                        </div>
                    </form>
                </div>
            </div>                  
