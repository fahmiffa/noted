                ...
                <div class="card-body">
                    ...
                    @endisset
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <button class="btn btn-success btn-sm" type="button" id="add-header">Tambah Item</button>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    <input type="text" name="body" value="{{ isset($form) ? $form->body : old('body')}}"  class="form-control">
                                    <button class="btn btn-success btn-sm" type="button" id="add-body">Tambah Title</button>
                                </div>
